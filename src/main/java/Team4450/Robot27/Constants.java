...
public final class Constants {
    public static String PROGRAM_NAME = "ORF27b1-09.01.26";
    ...
    // Rotation2d.ZERO);
    public static Pose2d HUB_BLUE_WELDED_POSE = new Pose2d(4.625, 4.034, Rotation2d.ZERO);
    // Red
    // public static Pose2d HUB_RED_ANDYMARK_POSE = new Pose2d(11.901, 4.021,
    // Rotation2d.ZERO);
    public static Pose2d HUB_RED_WELDED_POSE = new Pose2d(11.915, 4.034, Rotation2d.ZERO);

    public static double NEUTRAL_BLUE_ZONE_BARRIER_X = 4.572;
    public static double NEUTRAL_RED_ZONE_BARRIER_X = 11.938;

    public static Pose2d FERRY_BLUE_OUTPOST_CORNER = new Pose2d(-6.27, 0.635, Rotation2d.ZERO);
    public static Pose2d FERRY_BLUE_BLANK_CORNER = new Pose2d(-6.27, 7.407, Rotation2d.ZERO);

    public static Pose2d FERRY_RED_OUTPOST_CORNER = new Pose2d(20.243, 7.407, Rotation2d.ZERO);
    public static Pose2d FERRY_RED_BLANK_CORNER = new Pose2d(20.243, 0.635, Rotation2d.ZERO);
    ...
    public static final class DriveConstants {
        ...
        // Rotation2d.ZERO);
        public static final Pose2d DEFAULT_STARTING_POSE = new Pose2d(0, 0, Rotation2d.ZERO);
        public static final Pose3d DEFAULT_STARTING_POSE_3D = new Pose3d(0, 0, 0, Rotation3d.ZERO);
    }
};
